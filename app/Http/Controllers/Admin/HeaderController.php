...
class HeaderController extends Controller
{
    ...
    public function update(Request $request,Header $header)
    {
        ...
        return redirect()->route('header.index')->with('success','Datos actualizados correctamente');
    }
    ...
    public function destroy(Header $header)
    {
        ...
        $header->delete();
        return redirect()->route('header.index')->with('success','Datos eliminados correctamente');
    }
}
