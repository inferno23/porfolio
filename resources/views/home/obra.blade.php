    ...
    <section id="work" class="portfolio-mf sect-pt4 route">
      <div class="container">
        ...
        <div class="card-footer py-3">
          <a href="{{ route('obras') }}" class="btn btn-success btn-sm"> <- Volver al Calendario</a>
      </div>
        <div class="row">
          <div class="col-sm-12">
            <div class="title-box text-center">
              ...
              <p class="subtitle-a">{{ $obra->fecha }}              </p>
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-sm-12">
            <div class="work-box">
              <a href="{{ asset('storage/uploads/image/obra/'.$obra->image) }}" data-gall="portfolioGallery" class="venobox">
                <div class="work-img">
                  <img src="{{ asset('storage/uploads/image/obra/'.$obra->image) }}" alt="" class="img-fluid">
                </div>
              </a>
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-12">
                    <h2 class="w-title"> Dia:{{ $obra->fecha }} - Horario de Inicio: {{ $obra->horainicio }} hs</h2>
                    <div class="w-more">
                      <span class="w-ctegory">{{ $obra->descripcion }}</span>
                    </div>
                  </div>
                </div>
              </div>
