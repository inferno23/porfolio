...
<div class="card shadow mb-4">
    ...
    <div class="card-body"><h1>Solo Diputado Provincial de la provincia: {{ $provincia->provincia }}</h1>
        <form method="POST" action="{{ route('telegrama.storeDiputadoProv') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <thead>
                    ...
                    <th>Lista</th>
                        ...
                        <th>Diputado Provincial</th>
                    </tr>
                </thead>
                <tbody>
                           @foreach($diputados_provinciales as $model)
                           <tr>
                           <td  >
