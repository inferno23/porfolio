...
<div class="card shadow mb-4">
    ...
    <div class="card-body"><h1>Presidencia: {{ $pais->paisnombre }}</h1>
        <form method="POST" action="{{ route('telegrama.storePresidente') }}" enctype="multipart/form-data">
            @csrf
