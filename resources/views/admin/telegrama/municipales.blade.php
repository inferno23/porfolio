...
<div class="card shadow mb-4">
    ...
    <div class="card-body"><h1>Solo Delegados Municipales de la Localidad: {{ $localidad->localidad }}</h1>
        <form method="POST" action="{{ route('telegrama.storeMunicipal') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <thead>
                    ...
                    <th>Lista</th>
                        ...
                        <th>Delegado municipales</th>
                    </tr>
                </thead>
                <tbody>
                           @foreach($municipales as $model)
                           <tr>
                           <td  >
