...
<div class="card shadow mb-4">
    ...
    <div class="card-body"><h1>Solo Autoridades de la Localidad: {{ $localidad->localidad }}</h1>
        <form method="POST" action="{{ route('telegrama.storeLocalidad') }}" enctype="multipart/form-data">
            @csrf
