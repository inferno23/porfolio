...
<div class="card shadow mb-4">
    ...
    <div class="card-body"><h1>Solo Autoridades de la provincia: {{ $provincia->provincia }}</h1>
        <form method="POST" action="{{ route('telegrama.storeProvincia') }}" enctype="multipart/form-data">
            @csrf
