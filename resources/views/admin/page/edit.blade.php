@extends('layouts.backend.app',[
	'title' => 'Modificar paginas de Inicio',
	'pageTitle' => 'Modificar paginas de Inicio',
])
@section('content')
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form method="POST" enctype="multipart/form-data" action="{{ route('page.update',$page->id) }}">
            @csrf
            @method('PATCH')
            ...
            <div class="form-group">
                ...
                <div class="alert alert-danger">
                  <strong>No hay Imagen Principal registrada!</strong> Por favorr seleccione una a continuacion.
                </div>
                
                @else
                  <img src="{{ asset('storage/uploads/image/page/'.$page->image) }}" width="90" height="90">
                
                  <div class="alert alert-danger">
                   <strong> Si desea mantener la Imagen Principal actual!!<strong>  No cambie ni seleccione otra imagen
                  </div>
                @endif
                <div class="custom-file">
                  <input type="file" name="file" class="custom-file-input @error('file') is-invalid @enderror" id="customFile">
                  <label class="custom-file-label" for="customFile">Seleccione una imagen si desea cambiar la actual</label>
                </div>
                @error('file')
            ...
            <div class="form-group">
                <input  value="{{ $page->description }}" class="form-control @error('description') is-invalid @enderror" name="description" id="description" type="hidden">
                @error('description')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div id="toolbar-container">
              ...
              <p></p>
            <div class="form-group">
                <button type="submit" class="btn btn-success btn-sm">Actualizar pagina</button>
            </div>
        </form>
    </div>
</div>
