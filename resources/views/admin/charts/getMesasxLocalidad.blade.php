...
<div class="container">
 ...
 <div class="col-xs-6 col-sm-6 col-md-6"> 
      ...
      <select name="localidad_id" id="localidad_id" class="form-control" style='border-color:#1cc88a;'>
...
<script>
    ...
    function saveAsPDF() {
        ...
        fecha= 'GraficosLocalidad_'+provincia+date_format.getDate()+'/'+ (date_format.getMonth()+ 1) +'/'+date_format.getFullYear();
