...
<div  id="printableArea">
   <div class="col-xl-4 col-lg-5" >
                            <div class="card shadow mb-4 pull-left">
                                ...
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Participacion Consejal</h6>
                                </div>
...
<script>
    ...
    function saveAsPDF() {
        ...
        fecha= 'GraficosConsejal_'+date_format.getDate()+'/'+ (date_format.getMonth()+ 1) +'/'+date_format.getFullYear();
