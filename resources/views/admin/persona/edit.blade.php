@extends('layouts.backend.app',[
	'title' => 'Modificar Elector - Consulting Group',
	'pageTitle' => 'Modificar Elector',
])
@section('content')
@include('layouts.components.datatables')
@include('layouts.components.alert-dismissible')
<div class="card shadow mb-4">
    <div class="card-header py-3">Modificar Elector</div>
    <div class="card-body">
...
<div class="container">
 ...
 <div class="col-xs-6 col-sm-6 col-md-6"> 
      ...
      @foreach($localidades as  $model)
         <option value="{{$model->id}}"  <?php if( $model->id == $localidad_id) echo "selected style='background-color:#1cc88a;'  "; else echo "mm"; ?>> {{$model->localidad}}</option>
         @endforeach
      </select>
    </div>
    </div>
            ...
            <div class="form-group">
                ...
                <input required="" value="{{ $persona->nombre }}" class="form-control @error('nombre') is-invalid @enderror" name="nombre" id="nombre" type="">
                @error('nombre')
            ...
            <div class="form-group">
                ...
                <input required="" value="{{ $persona->dni }}" class="form-control @error('dni') is-invalid @enderror" name="dni" id="dni" type="">
                @error('dni')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="form-group">
                ...
                <input required="" value="{{ $persona->institucion }}" class="form-control @error('institucion') is-invalid @enderror" name="institucion" id="institucion" type="">
                @error('institucion')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="form-group">
                ...
                <input required="" value="{{ $persona->domicilio }}" class="form-control @error('domicilio') is-invalid @enderror" name="domicilio" id="domicilio" type="">
                @error('domicilio')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="form-group">
                ...
                <input required="" value="{{ $persona->mesa }}" class="form-control @error('mesa') is-invalid @enderror" name="mesa" id="mesa" type="">
                @error('mesa')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="form-group">
                ...
                <input required="" value="{{ $persona->orden }}" class="form-control @error('orden') is-invalid @enderror" name="orden" id="orden" type="">
                @error('orden')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
